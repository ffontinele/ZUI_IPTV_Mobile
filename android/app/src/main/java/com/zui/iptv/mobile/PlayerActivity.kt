...
class PlayerActivity : Activity() {
    ...
    override fun onCreate(b: Bundle?) {
        ...
        load(intent.getStringExtra("url") ?: "", intent.getLongExtra("resumeSec", 0), w, h)
    }

    private fun load(url: String, resumeSec: Long, w: Int, h: Int) {
        val p = player ?: return
    ...
    fun switchUrl(url: String) { load(url, 0, 0, 0) }
