    ...
    <div className="flex flex-col h-full px-4 py-4 overflow-y-auto">
      ...
      <div className="flex flex-col gap-5 mt-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <button type="button" onClick={() => { try { (window as any).open(`https://ffontinele.github.io/zui-sync/?id=${shortDeviceId}&key=${deviceKey}`, '_blank'); } catch { /* ignore */ } }} className="flex items-center gap-3 px-5 py-3.5 rounded-xl bg-white/[0.04] border border-[#E8B567]/40 text-left">
      ...
      <div className="flex flex-col items-center justify-start pb-4 gap-3 mt-4">
        ...
        <div className="flex flex-col items-center gap-0.5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button type="button" onClick={() => { try { (navigator as any).clipboard?.writeText(`https://ffontinele.github.io/zui-sync/?id=${shortDeviceId}&key=${deviceKey}`); } catch { /* ignore */ } }} className="text-[10px] px-2.5 py-1 rounded-full bg-white/10 text-white/70">📋 Copiar link</button>
          </div>
        </div>
